        ...
        <div class="row">
            <div class="col-md-4 portfolio-item">
                <a href="all_users.php">
                    <button class="col-md-12 btn btn-warning"><h2>Active Users</h2></button>
                </a>
            </div>
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <button class="col-md-12 btn btn-success"><h2><strike>Dashboard Users</strike></h2></button>
                </a>
            </div>
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <button class="col-md-12 btn btn-primary"><h2><strike>API Users</strike></h2></button>
                </a>
            </div>
        </div>
        <!-- /.row -->
