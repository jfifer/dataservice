...
<div class="container">
    <h2>Sales Team <small><?php echo date('l jS \of F Y h:i:s A'); ?></small></h2><br>
...
$sql1='SELECT userId,resellerId, concat(firstName," ",lastName) as name from user where isSalesRep and enabled;';
...
if ( $result=mysqli_query($conn,$sql1) ) {
  ...
  while ( $row=mysqli_fetch_assoc($result) ) {
    ...
    $name = $row['name'];
        ...
        echo "<tr>".
             "<td>"."<a href='?repId=".$repId."'>".$repId."</a>"."</td>".
             "<td>".$resellerId."</td>".
             "<td>".$name."</td>".
             "</tr>";
  }
