        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <label style="color:red;">The username you passed already exists OR your admin pin was incorrect. See admin if you are having trouble logging in or creating an account.</label>
