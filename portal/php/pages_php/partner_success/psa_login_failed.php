...
<div class="container">
  <img class="logo" src="../../../img/site_logo2.png" height="95px;" width="475px;">
    ...
    <!-- <h4>Welcome Back!</h4> -->
            <div class="alert alert-danger animated fadeInUp" id="output">Please check your username and password. <small><a href="../../../request_data.php" data-toggle="tooltip" title="Hint: admin, no password">Need Help?</a></small></div>
              <div class="avatar">
