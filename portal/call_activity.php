...
<script>
            ...
            AmCharts.ready(function () {
                ...
                latitudeGraph.title = "Call Activity";
        ...
        <div class="row" style="color:#ff5755; font-weight:bold; text-align:center;"><h3><h3></div>
        <div id="callAct" style="width:100%; height:400px;"></div>
